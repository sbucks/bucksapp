...
export class ReveldataService {
  ...
  getRevelData(fid) {
    ...
    return this.http.post('http://173.255.138.39:3000/entries/values', JSON.stringify(fid), {headers: headers}).map(res => res.json());
  }
  ...
  getPartyData(week) {
    ...
    return this.http.post('http://173.255.138.39:3000/entries/partyvalues',
